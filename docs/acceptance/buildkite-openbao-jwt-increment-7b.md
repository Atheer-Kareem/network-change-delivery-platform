...
step, and job metadata against the current validated Buildkite context. Mocked
HTTP adapter tests cover the login request, failure modes, metadata mismatches,
and bearer-token secrecy.
